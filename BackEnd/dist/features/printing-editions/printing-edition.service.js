...
var printing_edition_repository_1 = require("./printing-edition.repository");
function createBookService(book) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, printing_edition_repository_1.createBook(book)];
                case 1:
                    result = _a.sent();
                    if (!result) {
...
function getBooksService() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, printing_edition_repository_1.getBooks()];
                case 1:
                    result = _a.sent();
